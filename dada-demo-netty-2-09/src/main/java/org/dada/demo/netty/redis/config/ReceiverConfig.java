package org.dada.demo.netty.redis.config;

import org.dada.demo.netty.redis.MsgAgreementReceiver;
...
public class ReceiverConfig {
    ...
    public RedisMessageListenerContainer container(RedisConnectionFactory connectionFactory, MessageListenerAdapter msgAgreementListenerAdapter) {
        ...
        container.addMessageListener(msgAgreementListenerAdapter, new PatternTopic("dada-demo-netty-push-msgAgreement"));
        return container;
    }
