...
public class MyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        String sendMsg = "，欢迎您的关注&获取源码！不平凡的岁月终究来自你每日不停歇的刻苦拼搏，每一次真正成长都因看清脚下路而抉择出的生活。愿你我；承遇朝霞，年少正恰，整装戎马，刻印风华。\n" +
                ...
                "获取源码：\n" +
                "关注｛算法猫叔｝公众号获取源码，回复<用Java实现jvm源码>\n" +
                "关注｛算法猫叔｝公众号获取源码，回复<netty源码>\n" +
                "关注｛算法猫叔｝公众号获取源码，回复<rpc源码>\n" +
                "关注｛算法猫叔｝公众号获取源码，回复<基于JavaAgent的全链路监控>";
