...
import org.dada.demo.netty.domain.*;
import org.dada.demo.netty.domain.*;
import org.dada.demo.netty.util.CacheUtil;
import org.dada.demo.netty.util.FileUtil;
        ...
        switch (fileTransferProtocol.getTransferType()) {
            case 0:
                ...
                if (null != fileBurstInstructOld) {
                    ...
                    //传输完成删除断点信息
                    System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + " 算法猫叔服务端，接收客户端传输文件请求[断点续传]。" + JSON.toJSONString(fileBurstInstructOld));
                ...
                System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + " 算法猫叔服务端，接收客户端传输文件请求。" + JSON.toJSONString(fileDescInfo));
                break;
            case 2:
                ...
                System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + " 算法猫叔服务端，接收客户端传输文件数据。" + JSON.toJSONString(fileBurstData));
