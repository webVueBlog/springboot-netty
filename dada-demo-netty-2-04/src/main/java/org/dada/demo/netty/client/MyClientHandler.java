...
import org.dada.demo.netty.domain.Constants;
import org.dada.demo.netty.domain.FileBurstData;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        switch (fileTransferProtocol.getTransferType()) {
            case 1:
                ...
                System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + " 算法猫叔客户端传输文件信息。 FILE：" + fileBurstData.getFileName() + " SIZE(byte)：" + (fileBurstData.getEndPos() - fileBurstData.getBeginPos()));
                break;
            default:
                break;
        }
        ...
        System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + " 算法猫叔客户端传输文件信息[主动断开链接，模拟断点续传]");
        ctx.flush();
        ctx.close();
        System.exit(-1);*/
    }
